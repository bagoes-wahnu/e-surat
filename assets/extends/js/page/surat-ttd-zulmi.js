	...
	$.ajax({
		...
		success: function (response) {
			...
			if (obj.status == "OK") {
				...
				let template = '<div id="ttd-' + suratTtdData['id_detail'] + '" style="left:' + suratTtdData['left'] + 'px;top:' + suratTtdData['top'] + 'px" class="page-ttd"><img style="width: 100%;" src="' + baseUrl() + 'watch/' + suratTtdData['nama'] + '?un=' + suratTtdData['id_ttd'] + '&ct=tanda_tangan&src=' + suratTtdData['path_file'] + '"><label class="kt-avatar__upload no-print" data-toggle="kt-tooltip" title="" data-original-title="Hapus ttd" onclick="hapusTtd()"><i class="fa fa-times"></i></label></div>';

				$('#page-1').append(template);
